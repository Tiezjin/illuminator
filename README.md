...
### 💡 Best Use Case
* **Optimized for Light Mode:** Perfect for users who use Light Mode with custom background colors (Sepia, Grey, etc.) and automatically update link.
...
* **100% 本地化：** 所有处理均在本地 Web Worker 中完成。数据永远不会离开你的仓库。
